...
public class Adapter_plantas extends RecyclerView.Adapter<Adapter_plantas.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, final int i) {
        ...
        Glide.with(context).load("http://api-holcim.com/imagplantas/"+atributosList.get(i).getImagen()).into(viewHolder.txt_imagen);
    ...
    public void  Actializar_zona(final int idusuario, String idzona) {
        ...
        String HttpUrl = "http://api-holcim.com/actualizarzona.php?id="+idusuario+"&zona="+idzona;
